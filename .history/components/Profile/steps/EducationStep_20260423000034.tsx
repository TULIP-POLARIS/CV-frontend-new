...
const emptyItem = (): EducationItem => ({
  id: '', degree: '', fieldOfStudy: '', institution: '', startDate: '', endDate: '', description: '',
});
    ...
    <View style={styles.container}>
      ...
      {data.map((item, index) => (
        <View key={item.id || index} style={styles.card}>
          ...
          <Text style={styles.label}>{t('education.degree')}</Text>
          ...
          <Text style={styles.label}>{t('education.fieldOfStudy')}</Text>
          <View style={styles.inputRow}>
          ...
          <Text style={styles.label}>{t('education.institution')}</Text>
          <View style={styles.inputRow}>
          ...
          <View style={styles.row}>
            <View style={styles.halfField}>
              <Text style={styles.label}>{t('education.startDate')}</Text>
