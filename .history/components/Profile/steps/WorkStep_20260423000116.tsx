...
const emptyItem = (): WorkItem => ({
  id: '', jobTitle: '', company: '', location: '', startDate: '', endDate: '', isCurrent: false, description: '',
});
    ...
    <View style={styles.container}>
      ...
      {data.map((item, index) => (
        <View key={item.id || index} style={styles.card}>
          ...
          <Text style={styles.label}>{t('work.jobTitle')}</Text>
          ...
          <Text style={styles.label}>{t('work.company')}</Text>
          <View style={styles.inputRow}>
          ...
          <View style={styles.row}>
            <View style={styles.halfField}>
              <Text style={styles.label}>{t('work.startDate')}</Text>
