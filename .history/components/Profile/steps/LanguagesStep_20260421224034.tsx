    ...
    <View style={styles.container}>
      ...
      {data.map((item, index) => (
        <View key={item.id} style={styles.card}>
          ...
          <Text style={styles.label}>{t('languages.language')} <Text style={styles.required}>*</Text></Text>
          ...
          <Text style={styles.label}>{t('languages.proficiency')} <Text style={styles.required}>*</Text></Text>
