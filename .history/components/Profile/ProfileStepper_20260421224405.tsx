    ...
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <View style={styles.halfField}>
          ...
          <TextInput
            style={[styles.input, errors.includes('firstName') && styles.inputError]}
        ...
        <View style={styles.halfField}>
          ...
          <TextInput
            style={[styles.input, errors.includes('lastName') && styles.inputError]}
      ...
      <TouchableOpacity
        style={[styles.inputRow, errors.includes('dateOfBirth') && styles.inputError]}
      ...
      >
        ...
        <Icon name="chevron-down-outline" size={16} color="#90a4ae" />
      </TouchableOpacity>
      ...
      <View style={[styles.genderRow, errors.includes('gender') && styles.genderError]}>
        {GENDERS.map(g => (
          <TouchableOpacity
            key={g}
      ...
      <View style={[styles.inputRow, errors.includes('nationality') && styles.inputError]}>
      ...
      <View style={[styles.inputRow, errors.includes('countryOfResidence') && styles.inputError]}>
...
const styles = StyleSheet.create({
  ...
  genderRow: { flexDirection: 'row', gap: 10, borderRadius: 10, borderWidth: 1.5, borderColor: 'transparent', padding: 2 },
