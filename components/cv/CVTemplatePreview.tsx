            ...
            <View style={styles.timelineWrapper}>
              ...
              <View style={styles.timelineItem}>
                ...
                <View style={styles.timelineContent}>
                  ...
                  <Text style={styles.smallText}>Bachelor of IT (2024–2028)</Text>
                  <Text style={styles.smallText}>Oulu University of Applied Sciences</Text>
                </View>
              </View>
              ...
              <View style={styles.timelineItem}>
                ...
                <View style={styles.timelineContent}>
                  ...
                  <Text style={styles.smallText}>Intern - Web Developer (2025–Present)</Text>
                  <Text style={styles.smallText}>• Built web apps using React</Text>
                  <Text style={styles.smallText}>• Worked with REST APIs</Text>
                </View>
              </View>
